...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Job Portal / </span> Create</h4>
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('job-portal.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="basic-default-job-deadline" placeholder="Enter deadline"
                                    name="job_deadline" required />
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-editor">Job Details <span style="color: red;">*</span></label>
                            <div class="col-sm-10">
                                <textarea name="job_details" id="basic-default-editor" class="form-control" cols="30" rows="10"></textarea>
                            </div>
                        </div>
