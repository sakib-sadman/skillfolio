        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('faculty_dashboard') }}" class="app-brand-link">
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboard -->
                    <li class="menu-item {{ Request::routeIs('faculty_dashboard') ? 'active' : '' }}">
                        <a href="{{ route('faculty_dashboard') }}" class="menu-link ">
                    ...
                    <li class="menu-item {{ Request::routeIs('student_skills_list') ? 'active' : '' }}">
                        <a href="{{ route('student_skills_list') }}" class="menu-link">
                            <i class="menu-icon">
                    ...
                    <li class="menu-item {{ Request::routeIs('recommendation_list') || Request::routeIs('recommendation_view') ? 'active' : '' }}">
                        <a href="{{ route('recommendation_list') }}" class="menu-link">
                            <i class="menu-icon">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('faculty_profile') }}">
                                            <div class="d-flex">
